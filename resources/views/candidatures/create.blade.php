                ...
                <form method="POST" action="{{ route('candidatures.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="sm:col-span-2">
                            ...
                            <x-text-input id="entreprise" name="entreprise" type="text" class="mt-1 block w-full" :value="old('entreprise')" required />
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <x-text-input id="offre_url" name="offre_url" type="url" class="mt-1 block w-full" :value="old('offre_url')" placeholder="https://..." />
                        ...
                        <div>
                            ...
                            <x-text-input id="date_candidature" name="date_candidature" type="date" class="mt-1 block w-full" :value="old('date_candidature', date('Y-m-d'))" required />
                            <x-input-error :messages="$errors->get('date_candidature')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="document" value="Document (CV, lettre...)" />
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="notes" name="notes" rows="4" class="mt-1 block w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg shadow-sm">{{ old('notes') }}</textarea>
